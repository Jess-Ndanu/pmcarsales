...
export const Route = createFileRoute("/inventory")({
  ...
  head: () => ({
    meta: [
      { title: "Inventory — Apex Autos" },
      { name: "description", content: "Browse our full inventory of premium pre-owned vehicles. Filter by make, model, year, mileage, and price." },
    ],
  }),
      ...
      <div className="space-y-4">
        <div>
          ...
          <select value={p.make} onChange={(e) => p.setMake(e.target.value)} className={fieldCls}>
            ...
            {["Audi","BMW","Ford","Mercedes-Benz","Porsche","Range Rover","Tesla","Volkswagen"].map((m) => (
