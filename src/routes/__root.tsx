...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Apex Autos — Premium Pre-Owned Vehicles" },
      { property: "og:description", content: "Hand-picked premium pre-owned cars with transparent pricing and white-glove service." },
